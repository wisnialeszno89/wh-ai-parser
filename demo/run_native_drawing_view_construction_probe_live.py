...
def main() -> None:
    ...
    print(f'[DRAWING VIEW] hwnd={view.hwnd} class={view.class_name!r} rect={view.rect} hits={view.hits}')

    # Capture screen and crop only the native drawing view.
    ...
    # WindowHub constructions are typically saturated/outlined; stay conservative.
    ...
    payload = {
        'drawing_view': {'hwnd': view.hwnd, 'class': view.class_name, 'rect': view.rect, 'hits': view.hits},
        'candidates': [
